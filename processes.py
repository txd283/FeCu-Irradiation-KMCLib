...
# Cu --> Va diffusion processes for both first and second neighbours

processes.append(KMCProcess(coordinates=coordinates1,
                            elements_before=before_Cu_Va,
                            elements_after=after_Cu_Va,
                            move_vectors=move_vector1,
                            basis_sites=basis_sites,
                            rate_constant=rate))
...
# Cu --> Fe diffusion processes for both first and second neighbours

processes.append(KMCProcess(coordinates=coordinates1,
                            elements_before=before_Cu_Fe,
                            elements_after=after_Cu_Fe,
                            move_vectors=move_vector1,
                            basis_sites=basis_sites,
                            rate_constant=rate))
